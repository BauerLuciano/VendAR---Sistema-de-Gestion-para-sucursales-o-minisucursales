...
// Formulario de Inertia (sin puntos)
const form = useForm({
    nombre: '',
    dni: '',
    telefono: '',
...
// Calcula cuánto le queda de fiado
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr v-if="consumidores.length === 0">
                                <td colspan="6" class="p-8 text-center text-slate-400 font-bold">No hay clientes registrados.</td>
                            </tr>
            ...
            <div class="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden transform transition-all">
                ...
                <form @submit.prevent="submitForm" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input v-model="form.limite_cuenta_corriente" type="number" step="100" min="0" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 focus:ring-sky-500 focus:border-sky-500 font-medium text-slate-700" required>
                    </div>
