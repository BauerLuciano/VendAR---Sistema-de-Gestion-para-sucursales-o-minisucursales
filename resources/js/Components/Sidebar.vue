...
const menu = [
    ...
    },
    {
        ...
        enlaces: [
            { nombre: 'Caja Diaria', ruta: 'cajadiaria.index', icono: 'caja_diaria', roles: ['Cajero', 'Encargado', 'SuperAdmin'] }, 
    ...
    },
    {
        ...
        enlaces: [
            // 👇 ACÁ ESTÁ EL NUEVO BOTÓN DE REPOSICIÓN
